<?php 
	...
	{	
		...
		if($upload_ok==1 && empty($report)){
			$query = "UPDATE STUDENTS SET STUDENT_FIRSTNAME = :user_firstname, STUDENT_LASTNAME = :user_lastname, STUDENT_EMAIL = :user_email, STUDENT_CONTACT = :user_contact, STUDENT_PROFILE = '$file' WHERE STUDENT_ID = :user_id";
